...
display_banner <- function() {
  ...
  
  }"
  ...
  banner_split |> seq_along() |> lapply(\(i) {
    ...
    chars |> seq_along() |> lapply(\(j) {
      color <- make_style('black')
      if (chars[[j]] != ' ') {
        color_legend <- list(a = 'red', t = 'blue', c = 'yellow', g = 'green',
                             b = 'pink',d = 'orange', e = 'cyan', o = 'black', x = 'black', y = 'blue', z='black')
        color <- make_style(color_legend[[color_map_chars[[j]]]])
      }
